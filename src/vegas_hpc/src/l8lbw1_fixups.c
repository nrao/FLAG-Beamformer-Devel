...
void fixup_l8lbw1_block_merge(struct vegas_databuf *db, int num_needed, int input_blks[4])
{
    ...
    // We are collapsing 1,2 or 4 blocks into 1. The first gets the results
